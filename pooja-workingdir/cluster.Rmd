...
output: pdf_document
---
1. Initial attempt to see whether split-time "K0.5"" varies by Age group for 2010 data using kmeans. (Corresponding r-script can be found under github at statse139-project/cluster.R)
...
legend("topright", inset=c(-0.3,0), legend=c("Age (18,35]","Age (35,55]","Age (55,85]"), cex = 0.6, lwd=c(1.5,1.5,1.5), col=1:3,xpd=TRUE)
