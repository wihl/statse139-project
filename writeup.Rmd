...
Clearly, estimating the finish halfway through the race is far more accurate than the initial 5k split. While this may be useful to someone planning
to meet the runner at the finish, we felt it would be more challenging to minimize prediction errors using the 5k split time.
