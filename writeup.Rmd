...
We then examined the base model standard diagnostics such as residuals vs. predicted, Cook's Distance, heteroskedasticity.
...
we elected to perform a log transform of the response variable.
...
$R^2$ went from `r summary(base.mod)$r.squared` to `r summary(tx.mod)$r.squared`, a slight improvement. Adjusted $R^2$ improved by an equal amount.
...
Since the transformation yielded only a small improvement, we elected to try clustering the data into subgroups using $k$-Means.
