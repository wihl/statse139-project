...
1. Compare the accuracy of predictions made via our four models on a validation dataset of unseen results from the Boston Marathon and a secondary dataset of results from the Chicago Marathon 
...
hence half marathon time was a better predictor than the 5k split time. 
